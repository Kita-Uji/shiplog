...
- [ ] **LAYOUT-01**: Heatmap displays 3–4 months of data instead of 52 weeks
- [ ] **LAYOUT-02**: Heatmap fits within its container without horizontal overflow
- [ ] **LAYOUT-03**: App title is displayed at ~250% of current size
- [ ] **LAYOUT-04**: Desktop layout is scaled up ~150% (overall interface feels larger)
